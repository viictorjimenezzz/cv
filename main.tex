...
\begin{rSection}{Summary}
    ...
    Currently looking for research assistantship/internship opportunities to contribute to exciting research projects in machine learning 
...
\begin{rSection}{Experience}
    {\bf Uthereal}, Zurich \hfill {\em Since Jan. 2024} 
    ...
    \begin{itemize}
        \item Completed my master's thesis with Honors -- \textit{Improved robustness of deep learning models through posterior agreement based model selection}.
    \end{itemize}

    {\bf Physics ECS} -- TUM (Munich) \hfill {\em Feb. 2022 -- Oct. 2022} 
    \\ Research traineeship -- Prof. Dr. Aliaksandr Bandarenka \\
    \begin{itemize}
        \item Completed my bachelor's thesis with Honors -- \textit{EIS characterization of lithiated TiO2-coated LICGC electrolytes for the stabilization of the SEI in all-solid-state lithium batteries}.
...
Completed track in statistical learning, optimization theory and statistical inference.
Honors in machine learning, bayesian analysis and programming.
...
{\bf Erasmus ULISSES Project Ideathon} -- UL (Lisbon) \hfill  {\em Jul. 2023} \\
Three-week intensive ideathon aimed at addressing an ocean sustainability challenge.

{\bf LASSO and Bayes: A Demostration using Real State Market data} \hfill {\em 2023} 
\\ Bayesian analysis. \\
...
TD-PSOLA and Phase Vocoder algorithms in a STM32 NUCLEO-F303RE microprocessor} \hfill {\em 2021} 
